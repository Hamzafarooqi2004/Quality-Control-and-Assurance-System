...
namespace ES_projects
{
    public partial class leader : Form
    {
        ...
        {
            InitializeComponent();
            string connectionstr = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\USERS\\PMLS\\DOWNLOADS\\ES PROJECTS\\ES PROJECTS\\DATABASE1.MDF;Integrated Security=True";
            string projectName = "";
